...
public interface HospitalInformationService {
	 ...
	 * @return
	 */
	List<Map<String,Object>> selectHospitalInfo();
	...
	List<Map<String,Object>> modifyCheckHospital(String startTime,String endTime,String oldStartTime,String oldEndTime, String ids,String liveId);
