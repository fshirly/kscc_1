			         ...
			         <input type="hidden" id="speakerMain" name="speakerMain"/>
				        ...
				        <div class="imageView">
				            ...
				            <div class="colorSelect disNone">
				                  <div class="form-group text-right">
								      <span class="addColor"><i class="iconfont colorSubmit" title="提交" style="font-size:36px;">&#xe648;</i></span>
				                      <!-- <span style="margin-left:15px;"><i class="iconfont colorCancel" title="取消" style="font-size:36px;">&#xe99c;</i></span> -->
								  </div>
								  <div class="colorDivs">
				            ...
				            <div class="videoMani disNone">
				                  <div class="form-group text-right">
								      <span class="addVideo"><i class="iconfont videoSubmit" title="提交" style="font-size:36px;">&#xe648;</i></span>
				                      <!-- <span style="margin-left:15px;"><i class="iconfont videoCancel" title="取消" style="font-size:36px;">&#xe99c;</i></span> -->
								  </div>
								  <div class="videoDivs">
				            ...
				            <div class="delay disNone">
								  ...
								  <div class="form-group delayDivs">      
