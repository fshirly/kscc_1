				  ...
				  <div class="hosAdd active">
                    <form id="hosAddForm">
	                    <div class="clearfix mt-10">
	                        ...
	                        <input class="form-control form-width" id="hospitalNameAdd" role="{required:true,filterCN:true,length:60}"><dfn>*</dfn>
	                    </div>
	                    <div class="clearfix mt-10">
	                        <label class="text-right">医院简介：</label>
	                        <input class="form-control form-width" id="hospitalContentAdd" role="{length:200}">
	                    </div>
	                    <div class="clearfix mt-10">
	                        <label class="text-right">网站链接：</label>
	                        <input class="form-control form-width" id="hospitalUrlAdd" role="{length:100}">
	                    </div>
	                    <div class="clearfix mt-10">
                ...
                <div class="codecAdd">
                    <form id="codecAddForm">
	                    ...
	                    <div class="clearfix mt-10">
				            ...
				            <input class="form-control form-width" id="ownershipAdd" role="{required:true,length:20}"><dfn>*</dfn>
				        </div>
				        <div class="clearfix mt-10">
				        ...
				        <div class="clearfix mt-10">
				            ...
				            <input class="form-control form-width" id="accountAdd" role="{required:true,number:true,length:20}"><dfn>*</dfn>
				        </div>
			            <div class="clearfix mt-10">
			            ...
			            <div class="clearfix mt-10">
			                ...
			                <input class="form-control form-width" id="userNameAdd" role="{required:true,length:20}"><dfn>*</dfn>
			            </div>
			            <div class="clearfix mt-10">
			                <label class="text-right">密码：</label>
			                <input class="form-control form-width" type="password" id="userPasswordAdd" role="{required:true,length:50}"><dfn>*</dfn>
			            </div>
			            <div class="clearfix mt-10">
			                <label class="text-right">备注：</label>
			                <input class="form-control form-width" id="remarksAdd" role="{length:100}">
			            </div>
			        </form>
                </div>
			  </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pl-p15">
                <form id="hosFormEdit" method="post" action="">
                    <div class="clearfix mt-10">
                        <label class="text-right">医院名称：</label>
                        <input class="form-control form-width" id="hospitalNameEdit" role="{required:true,filterCN:true,length:60}"><dfn>*</dfn>
                    </div>
                    <div class="clearfix mt-10">
                        <label class="text-right">医院简介：</label>
                        <input class="form-control form-width" id="hospitalContentEdit" role="{length:200}">
                    </div>
                    <div class="clearfix mt-10">
                        <label class="text-right">网站链接：</label>
                        <input class="form-control form-width" id="hospitalUrlEdit" role="{length:100}">
                    </div>
                    <div class="clearfix mt-10">
			            <label class="text-right belongCity">医院地址：</label>
