	   ...
	   <form role="form" id="editLiveForm" method="post" enctype="multipart/form-data" action="">
		  ...
		  <div class="col-xs-4 col-sm-4 col-md-4" id="addImgDiv">
		     ...
		     <div class="form-group">
				...
				<textarea class="form-control" name="liveIntroduction" id ="liveIntroduction" value="" placeholder="最多500字符" role="{length:500}"></textarea>
			</div>
			...
			<div class="form-group" id="enclosureInput">
				...
				<label for="file" class="btn btn-primary inputLabel" >上传附件</label>
