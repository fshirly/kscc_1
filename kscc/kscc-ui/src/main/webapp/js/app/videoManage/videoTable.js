   ...
   //时间插件
    ...
    function setTable(){
        grid = $("#tblLiveApproval").DataTable({
            ...
            "columns":[
                {"title":"<span style='width: 60%;display:inline-block;text-align: left;padding-left: 20px;'>直播名称</span><span style='width:40%;display:inline-block;text-align: left'>直播开始时间</span>", "data":"title","sWidth":"35%"},
                {"title":"<div class='text-left'>手术医院</div>", "data":"hospitalname","sWidth":"16%"},
            ...
            "columnDefs":[
                {
                    "render":function(data,type,row,meta){
                        ...
                        if(row.hNum>1 && row.diffNum>1){
                            return "<div class='text-left' style='padding-left:20px'><span style='width:55%;display:inline-block'><a class='clickLive'hFlag='0' liveId='"+row.liveid+"'><i class='iconfont tableIcon' title='展开'>&#xe600;</i></a>"+row.title+"</span>" +
                                "<span style='width:45%;display:inline-block'>"+starttime+"</span></div>"
                        }else{
                            return "<div class='text-left'><span style='width:60%;display:inline-block'><a style='width:16px;height:17px;display:inline-block'></a>"+row.title+"</span><span style='width:40%;display:inline-block'>"+starttime+"</span></div>"
                        }
                ...
                },
                {
                    "render":function(data,type,row,meta){
                        //vNum 大于1才给展开按钮
                        if(row.vNum>1){
                            return "<div class='text-left' style='padding-left: 10px'><a class='clickHospital' liveId='"+row.liveid+"' hospitalId='"+row.hospitalid+"' vFlag='0'><i class='iconfont tableIcon' title='展开'>&#xe600;</i></a><span>"+row.hospitalname+"</span></div>"
                        }else{
                            return "<div class='text-left'style='padding-left: 10px'><a style='width:16px;height:17px;display:inline-block'></a>"+row.hospitalname+"</div>"
                        }
                ...
                },
                {
                    "render":function(data,type,row,meta){
                        ...
                        return "<div class='operateParent' filename='"+row.filename+"' bucket='"+row.bucket+"' fileId='"+row.id+"' filePath='"+row.filepath+"' hospitalId='"+row.hospitalid+"'>"+buttons+"</div>";
                    },
                    "targets":4
                }
            ],
    ...
    function setUserTable(hospital){
        $("#userTableLive").DataTable({
            ...
            "columns":[
                {"title":"<span style='width: 60%;display:inline-block;text-align: left;padding-left: 20px;'>直播名称</span><span style='width:40%;display:inline-block;text-align: left;'>直播开始时间</span>", "data":"title","sWidth":"50%"},
            ...
            "columnDefs":[
                ...
                },
                {
                    "render":function (data,type,row,meta) {
                        ...
                        return  "<div class='operateParent' filename='"+row.filename+"' bucket='"+row.bucket+"' fileId='"+row.id+"' filePath='"+row.filepath+"' hospitalId='"+row.hospitalid+"'>"+download+"</div>"
                    },
                    "targets":2
                }
            ],
