               ...
               var hostParams=data.participants;//参与方数据
         	   ...
         	   $.each(hostParams,function(i,v){
					if(v.serialNumber==1){
						...
						$("#liveParticipantView").append("<li att='"+v.hospitalId+"' class='participantsLi'><span class='iconfont iconfontList'>&#xe61e;</span><span class='controlParti' title='"+v.hospitalName+"'>"+v.hospitalName+"</span><span class='iconfont iconfontImg' title='第二主持人'>&#xe61c;</span></li>");
					}else{
